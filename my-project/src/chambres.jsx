...
const Chambres = () => {
    ...
    const reserverChambre1 = () => {
        const reservationsData = { checkin: reservationData.checkin , checkout: reservationData.checkout, promo : reservationData.checkout, chambre: "1" };
        navigate('/reservation', { state: reservationsData });
    }
    const reserverChambre2 = () => {
        const reservationsData = { checkin: reservationData.checkin , checkout: reservationData.checkout, promo : reservationData.checkout, chambre: "2" };
        navigate('/reservation', { state: reservationsData });
    }
    const reserverChambre3 = () => {
        const reservationsData = { checkin: reservationData.checkin , checkout: reservationData.checkout, promo : reservationData.checkout, chambre: "3" };
        navigate('/reservation', { state: reservationsData });
    }
    ...
    return (  
        ...
        <div className="flex flex-col justify-center items-center border-2 rounded-lg border-gray-300 p-4 ">
        ...
        <div className="flex flex-col justify-center items-center border-2 rounded-lg border-gray-300 mt-10 p-4">

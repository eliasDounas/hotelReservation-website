...
const Nav = () => {
    ...
    return ( 
        ...
        {/* {isOpen && 
            ( <div className="z-50 h-full fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center backdrop-blur-md bg-black bg-opacity-50" onClick={handleDialog}>
            <div className="absolute bg-white w-1/2">
        ...
        {isOpen && 
            ...
            <div className="z-40 h-auto w-1/4 mr-4 fixed top-20 right-0 flex flex-col items-start bg-white  border-x-2 border-b-2 border-gray-500 rounded-b-2xl pb-5" >
                ...
                <h1 className='ml-6 mt-10 font-medium text-xl text-blue-950'>La vie dont vous rêvez</h1>
                ...
                <h1 className='ml-6 mt-10 font-medium text-xl text-blue-950'>Béneficiez de 10% de réduction sur toutes vos réservations avec un seul compte!</h1>
          </div> </>)
     }</>
    )};
export default Nav;